...
\hypertarget{googletest-port-test_8cc_source}{}\label{googletest-port-test_8cc_source}\index{lib/googletest-\/master/googletest/test/googletest-\/port-\/test.cc@{lib/googletest-\/master/googletest/test/googletest-\/port-\/test.cc}}
...
\DoxyCodeLine{00283\ \textcolor{preprocessor}{\ \ \ \ GTEST\_OS\_NETBSD\ ||\ GTEST\_OS\_OPENBSD\ ||\ GTEST\_OS\_GNU\_HURD}}
...
\DoxyCodeLine{00292\ \ \ \textcolor{keywordtype}{size\_t}\ starting\_count;}
\DoxyCodeLine{00293\ \ \ \textcolor{keywordtype}{size\_t}\ thread\_count\_after\_create;}
\DoxyCodeLine{00294\ \ \ \textcolor{keywordtype}{size\_t}\ thread\_count\_after\_join;}
\DoxyCodeLine{00295\ }
\DoxyCodeLine{00296\ \ \ \textcolor{comment}{//\ We\ can't\ guarantee\ that\ no\ other\ thread\ was\ created\ or\ destroyed\ between}}
\DoxyCodeLine{00297\ \ \ \textcolor{comment}{//\ any\ two\ calls\ to\ GetThreadCount().\ We\ make\ multiple\ attempts,\ hoping\ that}}
\DoxyCodeLine{00298\ \ \ \textcolor{comment}{//\ background\ noise\ is\ not\ constant\ and\ we\ would\ see\ the\ "{}right"{}\ values\ at}}
\DoxyCodeLine{00299\ \ \ \textcolor{comment}{//\ some\ point.}}
\DoxyCodeLine{00300\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ attempt\ =\ 0;\ attempt\ <\ 20;\ ++attempt)\ \{}
\DoxyCodeLine{00301\ \ \ \ \ starting\_count\ =\ GetThreadCount();}
\DoxyCodeLine{00302\ \ \ \ \ pthread\_t\ thread\_id;}
\DoxyCodeLine{00303\ }
\DoxyCodeLine{00304\ \ \ \ \ internal::Mutex\ mutex;}
\DoxyCodeLine{00305\ \ \ \ \ \{}
\DoxyCodeLine{00306\ \ \ \ \ \ \ internal::MutexLock\ lock(\&mutex);}
\DoxyCodeLine{00307\ \ \ \ \ \ \ pthread\_attr\_t\ attr;}
\DoxyCodeLine{00308\ \ \ \ \ \ \ ASSERT\_EQ(0,\ pthread\_attr\_init(\&attr));}
\DoxyCodeLine{00309\ \ \ \ \ \ \ ASSERT\_EQ(0,\ pthread\_attr\_setdetachstate(\&attr,\ PTHREAD\_CREATE\_JOINABLE));}
\DoxyCodeLine{00310\ }
\DoxyCodeLine{00311\ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ status\ =\ pthread\_create(\&thread\_id,\ \&attr,\ \&ThreadFunc,\ \&mutex);}
\DoxyCodeLine{00312\ \ \ \ \ \ \ ASSERT\_EQ(0,\ pthread\_attr\_destroy(\&attr));}
\DoxyCodeLine{00313\ \ \ \ \ \ \ ASSERT\_EQ(0,\ status);}
\DoxyCodeLine{00314\ \ \ \ \ \}}
\DoxyCodeLine{00315\ }
\DoxyCodeLine{00316\ \ \ \ \ thread\_count\_after\_create\ =\ GetThreadCount();}
\DoxyCodeLine{00317\ }
\DoxyCodeLine{00318\ \ \ \ \ \textcolor{keywordtype}{void}*\ dummy;}
\DoxyCodeLine{00319\ \ \ \ \ ASSERT\_EQ(0,\ pthread\_join(thread\_id,\ \&dummy));}
\DoxyCodeLine{00320\ }
\DoxyCodeLine{00321\ \ \ \ \ \textcolor{comment}{//\ Join\ before\ we\ decide\ whether\ we\ need\ to\ retry\ the\ test.\ Retry\ if\ an}}
\DoxyCodeLine{00322\ \ \ \ \ \textcolor{comment}{//\ arbitrary\ other\ thread\ was\ created\ or\ destroyed\ in\ the\ meantime.}}
\DoxyCodeLine{00323\ \ \ \ \ \textcolor{keywordflow}{if}\ (thread\_count\_after\_create\ !=\ starting\_count\ +\ 1)\ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{00324\ }
\DoxyCodeLine{00325\ \ \ \ \ \textcolor{comment}{//\ The\ OS\ may\ not\ immediately\ report\ the\ updated\ thread\ count\ after}}
\DoxyCodeLine{00326\ \ \ \ \ \textcolor{comment}{//\ joining\ a\ thread,\ causing\ flakiness\ in\ this\ test.\ To\ counter\ that,\ we}}
\DoxyCodeLine{00327\ \ \ \ \ \textcolor{comment}{//\ wait\ for\ up\ to\ .5\ seconds\ for\ the\ OS\ to\ report\ the\ correct\ value.}}
\DoxyCodeLine{00328\ \ \ \ \ \textcolor{keywordtype}{bool}\ thread\_count\_matches\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{00329\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ 5;\ ++i)\ \{}
\DoxyCodeLine{00330\ \ \ \ \ \ \ thread\_count\_after\_join\ =\ GetThreadCount();}
\DoxyCodeLine{00331\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (thread\_count\_after\_join\ ==\ starting\_count)\ \{}
\DoxyCodeLine{00332\ \ \ \ \ \ \ \ \ thread\_count\_matches\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{00333\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00334\ \ \ \ \ \ \ \}}
\DoxyCodeLine{00335\ }
\DoxyCodeLine{00336\ \ \ \ \ \ \ SleepMilliseconds(100);}
\DoxyCodeLine{00337\ \ \ \ \ \}}
\DoxyCodeLine{00338\ }
\DoxyCodeLine{00339\ \ \ \ \ \textcolor{comment}{//\ Retry\ if\ an\ arbitrary\ other\ thread\ was\ created\ or\ destroyed.}}
\DoxyCodeLine{00340\ \ \ \ \ \textcolor{keywordflow}{if}\ (!thread\_count\_matches)\ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{00341\ }
\DoxyCodeLine{00342\ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00343\ \ \ \}}
\DoxyCodeLine{00344\ }
\DoxyCodeLine{00345\ \ \ EXPECT\_EQ(thread\_count\_after\_create,\ starting\_count\ +\ 1);}
\DoxyCodeLine{00346\ \ \ EXPECT\_EQ(thread\_count\_after\_join,\ starting\_count);}
\DoxyCodeLine{00347\ \}}
\DoxyCodeLine{00348\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00349\ TEST(GetThreadCountTest,\ ReturnsZeroWhenUnableToCountThreads)\ \{}
\DoxyCodeLine{00350\ \ \ EXPECT\_EQ(0U,\ GetThreadCount());}
\DoxyCodeLine{00351\ \}}
\DoxyCodeLine{00352\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GTEST\_OS\_LINUX\ ||\ GTEST\_OS\_MAC\ ||\ GTEST\_OS\_QNX\ ||\ GTEST\_OS\_FUCHSIA}}
\DoxyCodeLine{00353\ }
\DoxyCodeLine{00354\ TEST(GtestCheckDeathTest,\ DiesWithCorrectOutputOnFailure)\ \{}
\DoxyCodeLine{00355\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ a\_false\_condition\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{00356\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ regex[]\ =}
\DoxyCodeLine{00357\ \textcolor{preprocessor}{\#ifdef\ \_MSC\_VER}}
\DoxyCodeLine{00358\ \ \ \ \ \ \textcolor{stringliteral}{"{}googletest-\/port-\/test\(\backslash\)\(\backslash\).cc\(\backslash\)\(\backslash\)(\(\backslash\)\(\backslash\)d+\(\backslash\)\(\backslash\)):"{}}}
\DoxyCodeLine{00359\ \textcolor{preprocessor}{\#elif\ GTEST\_USES\_POSIX\_RE}}
\DoxyCodeLine{00360\ \ \ \ \ \ \textcolor{stringliteral}{"{}googletest-\/port-\/test\(\backslash\)\(\backslash\).cc:[0-\/9]+"{}}}
\DoxyCodeLine{00361\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00362\ \ \ \ \ \ \textcolor{stringliteral}{"{}googletest-\/port-\/test\(\backslash\)\(\backslash\).cc:\(\backslash\)\(\backslash\)d+"{}}}
\DoxyCodeLine{00363\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ \_MSC\_VER}}
\DoxyCodeLine{00364\ \ \ \ \ \ \textcolor{stringliteral}{"{}.*a\_false\_condition.*Extra\ info.*"{}};}
\DoxyCodeLine{00365\ }
\DoxyCodeLine{00366\ \ \ EXPECT\_DEATH\_IF\_SUPPORTED(GTEST\_CHECK\_(a\_false\_condition)\ <<\ \textcolor{stringliteral}{"{}Extra\ info"{}},}
\DoxyCodeLine{00367\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ regex);}
\DoxyCodeLine{00368\ \}}
\DoxyCodeLine{00369\ }
\DoxyCodeLine{00370\ \textcolor{preprocessor}{\#if\ GTEST\_HAS\_DEATH\_TEST}}
\DoxyCodeLine{00371\ }
\DoxyCodeLine{00372\ TEST(GtestCheckDeathTest,\ LivesSilentlyOnSuccess)\ \{}
\DoxyCodeLine{00373\ \ \ EXPECT\_EXIT(\{}
\DoxyCodeLine{00374\ \ \ \ \ \ \ GTEST\_CHECK\_(\textcolor{keyword}{true})\ <<\ \textcolor{stringliteral}{"{}Extra\ info"{}};}
\DoxyCodeLine{00375\ \ \ \ \ \ \ ::std::cerr\ <<\ \textcolor{stringliteral}{"{}Success\(\backslash\)n"{}};}
\DoxyCodeLine{00376\ \ \ \ \ \ \ exit(0);\ \},}
\DoxyCodeLine{00377\ \ \ \ \ \ \ ::testing::ExitedWithCode(0),\ \textcolor{stringliteral}{"{}Success"{}});}
\DoxyCodeLine{00378\ \}}
\DoxyCodeLine{00379\ }
\DoxyCodeLine{00380\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GTEST\_HAS\_DEATH\_TEST}}
\DoxyCodeLine{00381\ }
\DoxyCodeLine{00382\ \textcolor{comment}{//\ Verifies\ that\ Google\ Test\ choose\ regular\ expression\ engine\ appropriate\ to}}
\DoxyCodeLine{00383\ \textcolor{comment}{//\ the\ platform.\ The\ test\ will\ produce\ compiler\ errors\ in\ case\ of\ failure.}}
\DoxyCodeLine{00384\ \textcolor{comment}{//\ For\ simplicity,\ we\ only\ cover\ the\ most\ important\ platforms\ here.}}
\DoxyCodeLine{00385\ TEST(RegexEngineSelectionTest,\ SelectsCorrectRegexEngine)\ \{}
\DoxyCodeLine{00386\ \textcolor{preprocessor}{\#if\ !GTEST\_USES\_PCRE}}
\DoxyCodeLine{00387\ \textcolor{preprocessor}{\#\ if\ GTEST\_HAS\_POSIX\_RE}}
\DoxyCodeLine{00388\ }
\DoxyCodeLine{00389\ \ \ EXPECT\_TRUE(GTEST\_USES\_POSIX\_RE);}
\DoxyCodeLine{00390\ }
\DoxyCodeLine{00391\ \textcolor{preprocessor}{\#\ else}}
\DoxyCodeLine{00392\ }
\DoxyCodeLine{00393\ \ \ EXPECT\_TRUE(GTEST\_USES\_SIMPLE\_RE);}
\DoxyCodeLine{00394\ }
\DoxyCodeLine{00395\ \textcolor{preprocessor}{\#\ endif}}
\DoxyCodeLine{00396\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ !GTEST\_USES\_PCRE}}
\DoxyCodeLine{00397\ \}}
\DoxyCodeLine{00398\ }
...
\DoxyCodeLine{00818\ \}}
\DoxyCodeLine{00819\ }
\DoxyCodeLine{00820\ TEST(MatchRegexAtHeadTest,}
\DoxyCodeLine{00821\ \ \ \ \ \ WorksWhenRegexStartsWithRepetionOfEscapeSequence)\ \{}
\DoxyCodeLine{00822\ \ \ EXPECT\_FALSE(MatchRegexAtHead(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\).+a"{}},\ \textcolor{stringliteral}{"{}abc"{}}));}
\DoxyCodeLine{00823\ \ \ EXPECT\_FALSE(MatchRegexAtHead(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)s?b"{}},\ \textcolor{stringliteral}{"{}\ \ b"{}}));}
\DoxyCodeLine{00824\ }
\DoxyCodeLine{00825\ \ \ EXPECT\_TRUE(MatchRegexAtHead(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)(*a"{}},\ \textcolor{stringliteral}{"{}((((ab"{}}));}
\DoxyCodeLine{00826\ \ \ EXPECT\_TRUE(MatchRegexAtHead(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)\string^?b"{}},\ \textcolor{stringliteral}{"{}\string^b"{}}));}
\DoxyCodeLine{00827\ \ \ EXPECT\_TRUE(MatchRegexAtHead(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)\(\backslash\)\(\backslash\)?b"{}},\ \textcolor{stringliteral}{"{}b"{}}));}
\DoxyCodeLine{00828\ \ \ EXPECT\_TRUE(MatchRegexAtHead(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)\(\backslash\)\(\backslash\)?b"{}},\ \textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)b"{}}));}
\DoxyCodeLine{00829\ \}}
\DoxyCodeLine{00830\ }
\DoxyCodeLine{00831\ TEST(MatchRegexAtHeadTest,\ MatchesSequentially)\ \{}
\DoxyCodeLine{00832\ \ \ EXPECT\_FALSE(MatchRegexAtHead(\textcolor{stringliteral}{"{}ab.*c"{}},\ \textcolor{stringliteral}{"{}acabc"{}}));}
\DoxyCodeLine{00833\ }
\DoxyCodeLine{00834\ \ \ EXPECT\_TRUE(MatchRegexAtHead(\textcolor{stringliteral}{"{}ab.*c"{}},\ \textcolor{stringliteral}{"{}ab-\/fsc"{}}));}
\DoxyCodeLine{00835\ \}}
\DoxyCodeLine{00836\ }
\DoxyCodeLine{00837\ TEST(MatchRegexAnywhereTest,\ ReturnsFalseWhenStringIsNull)\ \{}
\DoxyCodeLine{00838\ \ \ EXPECT\_FALSE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}"{}},\ NULL));}
\DoxyCodeLine{00839\ \}}
\DoxyCodeLine{00840\ }
\DoxyCodeLine{00841\ TEST(MatchRegexAnywhereTest,\ WorksWhenRegexStartsWithCaret)\ \{}
\DoxyCodeLine{00842\ \ \ EXPECT\_FALSE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}\string^a"{}},\ \textcolor{stringliteral}{"{}ba"{}}));}
\DoxyCodeLine{00843\ \ \ EXPECT\_FALSE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}\string^\$"{}},\ \textcolor{stringliteral}{"{}a"{}}));}
\DoxyCodeLine{00844\ }
\DoxyCodeLine{00845\ \ \ EXPECT\_TRUE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}\string^a"{}},\ \textcolor{stringliteral}{"{}ab"{}}));}
\DoxyCodeLine{00846\ \ \ EXPECT\_TRUE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}\string^"{}},\ \textcolor{stringliteral}{"{}ab"{}}));}
\DoxyCodeLine{00847\ \ \ EXPECT\_TRUE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}\string^\$"{}},\ \textcolor{stringliteral}{"{}"{}}));}
\DoxyCodeLine{00848\ \}}
\DoxyCodeLine{00849\ }
\DoxyCodeLine{00850\ TEST(MatchRegexAnywhereTest,\ ReturnsFalseWhenNoMatch)\ \{}
\DoxyCodeLine{00851\ \ \ EXPECT\_FALSE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}a"{}},\ \textcolor{stringliteral}{"{}bcde123"{}}));}
\DoxyCodeLine{00852\ \ \ EXPECT\_FALSE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}a.+a"{}},\ \textcolor{stringliteral}{"{}-\/-\/aa88888888"{}}));}
\DoxyCodeLine{00853\ \}}
\DoxyCodeLine{00854\ }
\DoxyCodeLine{00855\ TEST(MatchRegexAnywhereTest,\ ReturnsTrueWhenMatchingPrefix)\ \{}
\DoxyCodeLine{00856\ \ \ EXPECT\_TRUE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)w+"{}},\ \textcolor{stringliteral}{"{}ab1\_\ -\/\ 5"{}}));}
\DoxyCodeLine{00857\ \ \ EXPECT\_TRUE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}.*="{}},\ \textcolor{stringliteral}{"{}="{}}));}
\DoxyCodeLine{00858\ \ \ EXPECT\_TRUE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}x.*ab?.*bc"{}},\ \textcolor{stringliteral}{"{}xaaabc"{}}));}
\DoxyCodeLine{00859\ \}}
\DoxyCodeLine{00860\ }
\DoxyCodeLine{00861\ TEST(MatchRegexAnywhereTest,\ ReturnsTrueWhenMatchingNonPrefix)\ \{}
\DoxyCodeLine{00862\ \ \ EXPECT\_TRUE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)w+"{}},\ \textcolor{stringliteral}{"{}\$\$\$\ ab1\_\ -\/\ 5"{}}));}
\DoxyCodeLine{00863\ \ \ EXPECT\_TRUE(MatchRegexAnywhere(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\).+="{}},\ \textcolor{stringliteral}{"{}=\ \ ...="{}}));}
\DoxyCodeLine{00864\ \}}
\DoxyCodeLine{00865\ }
\DoxyCodeLine{00866\ \textcolor{comment}{//\ Tests\ RE's\ implicit\ constructors.}}
\DoxyCodeLine{00867\ TEST(RETest,\ ImplicitConstructorWorks)\ \{}
\DoxyCodeLine{00868\ \ \ \textcolor{keyword}{const}\ RE\ empty(\textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00869\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}"{}},\ empty.pattern());}
\DoxyCodeLine{00870\ }
\DoxyCodeLine{00871\ \ \ \textcolor{keyword}{const}\ RE\ simple(\textcolor{stringliteral}{"{}hello"{}});}
\DoxyCodeLine{00872\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}hello"{}},\ simple.pattern());}
\DoxyCodeLine{00873\ \}}
\DoxyCodeLine{00874\ }
\DoxyCodeLine{00875\ \textcolor{comment}{//\ Tests\ that\ RE's\ constructors\ reject\ invalid\ regular\ expressions.}}
\DoxyCodeLine{00876\ TEST(RETest,\ RejectsInvalidRegex)\ \{}
\DoxyCodeLine{00877\ \ \ EXPECT\_NONFATAL\_FAILURE(\{}
\DoxyCodeLine{00878\ \ \ \ \ \textcolor{keyword}{const}\ RE\ normal(NULL);}
\DoxyCodeLine{00879\ \ \ \},\ \textcolor{stringliteral}{"{}NULL\ is\ not\ a\ valid\ simple\ regular\ expression"{}});}
\DoxyCodeLine{00880\ }
\DoxyCodeLine{00881\ \ \ EXPECT\_NONFATAL\_FAILURE(\{}
\DoxyCodeLine{00882\ \ \ \ \ \textcolor{keyword}{const}\ RE\ normal(\textcolor{stringliteral}{"{}.*(\(\backslash\)\(\backslash\)w+"{}});}
\DoxyCodeLine{00883\ \ \ \},\ \textcolor{stringliteral}{"{}'('\ is\ unsupported"{}});}
\DoxyCodeLine{00884\ }
\DoxyCodeLine{00885\ \ \ EXPECT\_NONFATAL\_FAILURE(\{}
\DoxyCodeLine{00886\ \ \ \ \ \textcolor{keyword}{const}\ RE\ invalid(\textcolor{stringliteral}{"{}\string^?"{}});}
\DoxyCodeLine{00887\ \ \ \},\ \textcolor{stringliteral}{"{}'?'\ can\ only\ follow\ a\ repeatable\ token"{}});}
\DoxyCodeLine{00888\ \}}
\DoxyCodeLine{00889\ }
\DoxyCodeLine{00890\ \textcolor{comment}{//\ Tests\ RE::FullMatch().}}
\DoxyCodeLine{00891\ TEST(RETest,\ FullMatchWorks)\ \{}
\DoxyCodeLine{00892\ \ \ \textcolor{keyword}{const}\ RE\ empty(\textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00893\ \ \ EXPECT\_TRUE(RE::FullMatch(\textcolor{stringliteral}{"{}"{}},\ empty));}
\DoxyCodeLine{00894\ \ \ EXPECT\_FALSE(RE::FullMatch(\textcolor{stringliteral}{"{}a"{}},\ empty));}
\DoxyCodeLine{00895\ }
\DoxyCodeLine{00896\ \ \ \textcolor{keyword}{const}\ RE\ re1(\textcolor{stringliteral}{"{}a"{}});}
\DoxyCodeLine{00897\ \ \ EXPECT\_TRUE(RE::FullMatch(\textcolor{stringliteral}{"{}a"{}},\ re1));}
\DoxyCodeLine{00898\ }
\DoxyCodeLine{00899\ \ \ \textcolor{keyword}{const}\ RE\ re(\textcolor{stringliteral}{"{}a.*z"{}});}
\DoxyCodeLine{00900\ \ \ EXPECT\_TRUE(RE::FullMatch(\textcolor{stringliteral}{"{}az"{}},\ re));}
\DoxyCodeLine{00901\ \ \ EXPECT\_TRUE(RE::FullMatch(\textcolor{stringliteral}{"{}axyz"{}},\ re));}
\DoxyCodeLine{00902\ \ \ EXPECT\_FALSE(RE::FullMatch(\textcolor{stringliteral}{"{}baz"{}},\ re));}
\DoxyCodeLine{00903\ \ \ EXPECT\_FALSE(RE::FullMatch(\textcolor{stringliteral}{"{}azy"{}},\ re));}
\DoxyCodeLine{00904\ \}}
\DoxyCodeLine{00905\ }
\DoxyCodeLine{00906\ \textcolor{comment}{//\ Tests\ RE::PartialMatch().}}
\DoxyCodeLine{00907\ TEST(RETest,\ PartialMatchWorks)\ \{}
\DoxyCodeLine{00908\ \ \ \textcolor{keyword}{const}\ RE\ empty(\textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00909\ \ \ EXPECT\_TRUE(RE::PartialMatch(\textcolor{stringliteral}{"{}"{}},\ empty));}
\DoxyCodeLine{00910\ \ \ EXPECT\_TRUE(RE::PartialMatch(\textcolor{stringliteral}{"{}a"{}},\ empty));}
\DoxyCodeLine{00911\ }
\DoxyCodeLine{00912\ \ \ \textcolor{keyword}{const}\ RE\ re(\textcolor{stringliteral}{"{}a.*z"{}});}
\DoxyCodeLine{00913\ \ \ EXPECT\_TRUE(RE::PartialMatch(\textcolor{stringliteral}{"{}az"{}},\ re));}
\DoxyCodeLine{00914\ \ \ EXPECT\_TRUE(RE::PartialMatch(\textcolor{stringliteral}{"{}axyz"{}},\ re));}
\DoxyCodeLine{00915\ \ \ EXPECT\_TRUE(RE::PartialMatch(\textcolor{stringliteral}{"{}baz"{}},\ re));}
\DoxyCodeLine{00916\ \ \ EXPECT\_TRUE(RE::PartialMatch(\textcolor{stringliteral}{"{}azy"{}},\ re));}
\DoxyCodeLine{00917\ \ \ EXPECT\_FALSE(RE::PartialMatch(\textcolor{stringliteral}{"{}zza"{}},\ re));}
\DoxyCodeLine{00918\ \}}
\DoxyCodeLine{00919\ }
\DoxyCodeLine{00920\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GTEST\_USES\_POSIX\_RE}}
\DoxyCodeLine{00921\ }
\DoxyCodeLine{00922\ \textcolor{preprocessor}{\#if\ !GTEST\_OS\_WINDOWS\_MOBILE}}
\DoxyCodeLine{00923\ }
\DoxyCodeLine{00924\ TEST(CaptureTest,\ CapturesStdout)\ \{}
\DoxyCodeLine{00925\ \ \ CaptureStdout();}
\DoxyCodeLine{00926\ \ \ fprintf(stdout,\ \textcolor{stringliteral}{"{}abc"{}});}
\DoxyCodeLine{00927\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}abc"{}},\ GetCapturedStdout().c\_str());}
\DoxyCodeLine{00928\ }
\DoxyCodeLine{00929\ \ \ CaptureStdout();}
\DoxyCodeLine{00930\ \ \ fprintf(stdout,\ \textcolor{stringliteral}{"{}def\%cghi"{}},\ \textcolor{charliteral}{'\(\backslash\)0'});}
\DoxyCodeLine{00931\ \ \ EXPECT\_EQ(::std::string(\textcolor{stringliteral}{"{}def\(\backslash\)0ghi"{}},\ 7),\ ::std::string(GetCapturedStdout()));}
\DoxyCodeLine{00932\ \}}
\DoxyCodeLine{00933\ }
\DoxyCodeLine{00934\ TEST(CaptureTest,\ CapturesStderr)\ \{}
\DoxyCodeLine{00935\ \ \ CaptureStderr();}
\DoxyCodeLine{00936\ \ \ fprintf(stderr,\ \textcolor{stringliteral}{"{}jkl"{}});}
\DoxyCodeLine{00937\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}jkl"{}},\ GetCapturedStderr().c\_str());}
\DoxyCodeLine{00938\ }
...
\DoxyCodeLine{00941\ \ \ EXPECT\_EQ(::std::string(\textcolor{stringliteral}{"{}jkl\(\backslash\)0mno"{}},\ 7),\ ::std::string(GetCapturedStderr()));}
\DoxyCodeLine{00942\ \}}
\DoxyCodeLine{00943\ }
\DoxyCodeLine{00944\ \textcolor{comment}{//\ Tests\ that\ stdout\ and\ stderr\ capture\ don't\ interfere\ with\ each\ other.}}
\DoxyCodeLine{00945\ TEST(CaptureTest,\ CapturesStdoutAndStderr)\ \{}
\DoxyCodeLine{00946\ \ \ CaptureStdout();}
...
\DoxyCodeLine{00950\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}pqr"{}},\ GetCapturedStdout().c\_str());}
\DoxyCodeLine{00951\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}stu"{}},\ GetCapturedStderr().c\_str());}
\DoxyCodeLine{00952\ \}}
\DoxyCodeLine{00953\ }
\DoxyCodeLine{00954\ TEST(CaptureDeathTest,\ CannotReenterStdoutCapture)\ \{}
\DoxyCodeLine{00955\ \ \ CaptureStdout();}
\DoxyCodeLine{00956\ \ \ EXPECT\_DEATH\_IF\_SUPPORTED(CaptureStdout(),}
\DoxyCodeLine{00957\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}Only\ one\ stdout\ capturer\ can\ exist\ at\ a\ time"{}});}
\DoxyCodeLine{00958\ \ \ GetCapturedStdout();}
\DoxyCodeLine{00959\ }
...
\DoxyCodeLine{00962\ \}}
\DoxyCodeLine{00963\ }
\DoxyCodeLine{00964\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ !GTEST\_OS\_WINDOWS\_MOBILE}}
\DoxyCodeLine{00965\ }
\DoxyCodeLine{00966\ TEST(ThreadLocalTest,\ DefaultConstructorInitializesToDefaultValues)\ \{}
\DoxyCodeLine{00967\ \ \ ThreadLocal<int>\ t1;}
\DoxyCodeLine{00968\ \ \ EXPECT\_EQ(0,\ t1.get());}
\DoxyCodeLine{00969\ }
\DoxyCodeLine{00970\ \ \ ThreadLocal<void*>\ t2;}
\DoxyCodeLine{00971\ \ \ EXPECT\_TRUE(t2.get()\ ==\ \textcolor{keyword}{nullptr});}
\DoxyCodeLine{00972\ \}}
\DoxyCodeLine{00973\ }
\DoxyCodeLine{00974\ TEST(ThreadLocalTest,\ SingleParamConstructorInitializesToParam)\ \{}
\DoxyCodeLine{00975\ \ \ ThreadLocal<int>\ t1(123);}
\DoxyCodeLine{00976\ \ \ EXPECT\_EQ(123,\ t1.get());}
\DoxyCodeLine{00977\ }
\DoxyCodeLine{00978\ \ \ \textcolor{keywordtype}{int}\ i\ =\ 0;}
\DoxyCodeLine{00979\ \ \ ThreadLocal<int*>\ t2(\&i);}
\DoxyCodeLine{00980\ \ \ EXPECT\_EQ(\&i,\ t2.get());}
\DoxyCodeLine{00981\ \}}
\DoxyCodeLine{00982\ }
\DoxyCodeLine{00983\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtesting_1_1internal_1_1_no_default_contructor}{NoDefaultContructor}}\ \{}
\DoxyCodeLine{00984\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00985\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classtesting_1_1internal_1_1_no_default_contructor}{NoDefaultContructor}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*)\ \{\}}
\DoxyCodeLine{00986\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_no_default_contructor}{NoDefaultContructor}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1_no_default_contructor}{NoDefaultContructor}}\&)\ \{\}}
\DoxyCodeLine{00987\ \};}
\DoxyCodeLine{00988\ }
\DoxyCodeLine{00989\ TEST(ThreadLocalTest,\ ValueDefaultContructorIsNotRequiredForParamVersion)\ \{}
\DoxyCodeLine{00990\ \ \ ThreadLocal<NoDefaultContructor>\ bar(\mbox{\hyperlink{classtesting_1_1internal_1_1_no_default_contructor}{NoDefaultContructor}}(\textcolor{stringliteral}{"{}foo"{}}));}
\DoxyCodeLine{00991\ \ \ bar.pointer();}
\DoxyCodeLine{00992\ \}}
\DoxyCodeLine{00993\ }
\DoxyCodeLine{00994\ TEST(ThreadLocalTest,\ GetAndPointerReturnSameValue)\ \{}
\DoxyCodeLine{00995\ \ \ ThreadLocal<std::string>\ thread\_local\_string;}
\DoxyCodeLine{00996\ }
...
\DoxyCodeLine{01000\ \ \ thread\_local\_string.set(\textcolor{stringliteral}{"{}foo"{}});}
\DoxyCodeLine{01001\ \ \ EXPECT\_EQ(thread\_local\_string.pointer(),\ \&(thread\_local\_string.get()));}
\DoxyCodeLine{01002\ \}}
\DoxyCodeLine{01003\ }
\DoxyCodeLine{01004\ TEST(ThreadLocalTest,\ PointerAndConstPointerReturnSameValue)\ \{}
\DoxyCodeLine{01005\ \ \ ThreadLocal<std::string>\ thread\_local\_string;}
\DoxyCodeLine{01006\ \ \ \textcolor{keyword}{const}\ ThreadLocal<std::string>\&\ const\_thread\_local\_string\ =}
\DoxyCodeLine{01007\ \ \ \ \ \ \ thread\_local\_string;}
\DoxyCodeLine{01008\ }
\DoxyCodeLine{01009\ \ \ EXPECT\_EQ(thread\_local\_string.pointer(),\ const\_thread\_local\_string.pointer());}
\DoxyCodeLine{01010\ }
\DoxyCodeLine{01011\ \ \ thread\_local\_string.set(\textcolor{stringliteral}{"{}foo"{}});}
\DoxyCodeLine{01012\ \ \ EXPECT\_EQ(thread\_local\_string.pointer(),\ const\_thread\_local\_string.pointer());}
\DoxyCodeLine{01013\ \}}
\DoxyCodeLine{01014\ }
\DoxyCodeLine{01015\ \textcolor{preprocessor}{\#if\ GTEST\_IS\_THREADSAFE}}
\DoxyCodeLine{01016\ }
\DoxyCodeLine{01017\ \textcolor{keywordtype}{void}\ AddTwo(\textcolor{keywordtype}{int}*\ param)\ \{\ *param\ +=\ 2;\ \}}
\DoxyCodeLine{01018\ }
\DoxyCodeLine{01019\ TEST(ThreadWithParamTest,\ ConstructorExecutesThreadFunc)\ \{}
\DoxyCodeLine{01020\ \ \ \textcolor{keywordtype}{int}\ i\ =\ 40;}
\DoxyCodeLine{01021\ \ \ ThreadWithParam<int*>\ thread(\&AddTwo,\ \&i,\ \textcolor{keyword}{nullptr});}
\DoxyCodeLine{01022\ \ \ thread.Join();}
\DoxyCodeLine{01023\ \ \ EXPECT\_EQ(42,\ i);}
\DoxyCodeLine{01024\ \}}
\DoxyCodeLine{01025\ }
\DoxyCodeLine{01026\ TEST(MutexDeathTest,\ AssertHeldShouldAssertWhenNotLocked)\ \{}
\DoxyCodeLine{01027\ \ \ \textcolor{comment}{//\ AssertHeld()\ is\ flaky\ only\ in\ the\ presence\ of\ multiple\ threads\ accessing}}
\DoxyCodeLine{01028\ \ \ \textcolor{comment}{//\ the\ lock.\ In\ this\ case,\ the\ test\ is\ robust.}}
\DoxyCodeLine{01029\ \ \ EXPECT\_DEATH\_IF\_SUPPORTED(\{}
...
\DoxyCodeLine{01053\ \ \ \ \ \ \ \textcolor{comment}{//\ value\_\ rearranged\ with\ the\ call\ to\ SleepMilliseconds\ when\ observed}}
...
\DoxyCodeLine{01063\ }
\DoxyCodeLine{01064\ \ \ \ \ \ \ SleepMilliseconds(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(random\_.Generate(30)));}
\DoxyCodeLine{01065\ }
\DoxyCodeLine{01066\ \ \ \ \ \ \ GTEST\_CHECK\_POSIX\_SUCCESS\_(pthread\_mutex\_unlock(\&memory\_barrier\_mutex));}
\DoxyCodeLine{01067\ \ \ \ \ \ \ GTEST\_CHECK\_POSIX\_SUCCESS\_(pthread\_mutex\_destroy(\&memory\_barrier\_mutex));}
\DoxyCodeLine{01068\ \textcolor{preprocessor}{\#elif\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{01069\ \ \ \ \ \ \ \textcolor{comment}{//\ On\ Windows,\ performing\ an\ interlocked\ access\ puts\ up\ a\ memory\ barrier.}}
\DoxyCodeLine{01070\ \ \ \ \ \ \ \textcolor{keyword}{volatile}\ LONG\ dummy\ =\ 0;}
\DoxyCodeLine{01071\ \ \ \ \ \ \ ::InterlockedIncrement(\&dummy);}
\DoxyCodeLine{01072\ \ \ \ \ \ \ SleepMilliseconds(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(random\_.Generate(30)));}
\DoxyCodeLine{01073\ \ \ \ \ \ \ ::InterlockedIncrement(\&dummy);}
\DoxyCodeLine{01074\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{01075\ \textcolor{preprocessor}{\#\ error\ "{}Memory\ barrier\ not\ implemented\ on\ this\ platform."{}}}
\DoxyCodeLine{01076\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GTEST\_HAS\_PTHREAD}}
\DoxyCodeLine{01077\ \ \ \ \ \}}
\DoxyCodeLine{01078\ \ \ \ \ value\_\ =\ temp\ +\ 1;}
\DoxyCodeLine{01079\ \ \ \}}
\DoxyCodeLine{01080\ \ \ \textcolor{keywordtype}{int}\ value()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ value\_;\ \}}
\DoxyCodeLine{01081\ }
\DoxyCodeLine{01082\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{01083\ \ \ \textcolor{keyword}{volatile}\ \textcolor{keywordtype}{int}\ value\_;}
\DoxyCodeLine{01084\ \ \ Mutex*\ \textcolor{keyword}{const}\ mutex\_;\ \ \textcolor{comment}{//\ Protects\ value\_.}}
\DoxyCodeLine{01085\ \ \ Random\ \ \ \ \ \ \ random\_;}
\DoxyCodeLine{01086\ \};}
\DoxyCodeLine{01087\ }
\DoxyCodeLine{01088\ \textcolor{keywordtype}{void}\ CountingThreadFunc(pair<AtomicCounterWithMutex*,\ int>\ param)\ \{}
\DoxyCodeLine{01089\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ param.second;\ ++i)}
\DoxyCodeLine{01090\ \ \ \ \ \ \ param.first-\/>Increment();}
\DoxyCodeLine{01091\ \}}
\DoxyCodeLine{01092\ }
\DoxyCodeLine{01093\ \textcolor{comment}{//\ Tests\ that\ the\ mutex\ only\ lets\ one\ thread\ at\ a\ time\ to\ lock\ it.}}
\DoxyCodeLine{01094\ TEST(MutexTest,\ OnlyOneThreadCanLockAtATime)\ \{}
\DoxyCodeLine{01095\ \ \ Mutex\ mutex;}
\DoxyCodeLine{01096\ \ \ AtomicCounterWithMutex\ locked\_counter(\&mutex);}
\DoxyCodeLine{01097\ }
\DoxyCodeLine{01098\ \ \ \textcolor{keyword}{typedef}\ ThreadWithParam<pair<AtomicCounterWithMutex*,\ int>\ >\ ThreadType;}
\DoxyCodeLine{01099\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ kCycleCount\ =\ 20;}
\DoxyCodeLine{01100\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ kThreadCount\ =\ 7;}
\DoxyCodeLine{01101\ \ \ std::unique\_ptr<ThreadType>\ counting\_threads[kThreadCount];}
\DoxyCodeLine{01102\ \ \ Notification\ threads\_can\_start;}
\DoxyCodeLine{01103\ \ \ \textcolor{comment}{//\ Creates\ and\ runs\ kThreadCount\ threads\ that\ increment\ locked\_counter}}
\DoxyCodeLine{01104\ \ \ \textcolor{comment}{//\ kCycleCount\ times\ each.}}
\DoxyCodeLine{01105\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ kThreadCount;\ ++i)\ \{}
\DoxyCodeLine{01106\ \ \ \ \ counting\_threads[i].reset(\textcolor{keyword}{new}\ ThreadType(\&CountingThreadFunc,}
\DoxyCodeLine{01107\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ make\_pair(\&locked\_counter,}
\DoxyCodeLine{01108\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ kCycleCount),}
\DoxyCodeLine{01109\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \&threads\_can\_start));}
\DoxyCodeLine{01110\ \ \ \}}
\DoxyCodeLine{01111\ \ \ threads\_can\_start.Notify();}
\DoxyCodeLine{01112\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ kThreadCount;\ ++i)}
\DoxyCodeLine{01113\ \ \ \ \ counting\_threads[i]-\/>Join();}
\DoxyCodeLine{01114\ }
\DoxyCodeLine{01115\ \ \ \textcolor{comment}{//\ If\ the\ mutex\ lets\ more\ than\ one\ thread\ to\ increment\ the\ counter\ at\ a}}
\DoxyCodeLine{01116\ \ \ \textcolor{comment}{//\ time,\ they\ are\ likely\ to\ encounter\ a\ race\ condition\ and\ have\ some}}
\DoxyCodeLine{01117\ \ \ \textcolor{comment}{//\ increments\ overwritten,\ resulting\ in\ the\ lower\ then\ expected\ counter}}
\DoxyCodeLine{01118\ \ \ \textcolor{comment}{//\ value.}}
\DoxyCodeLine{01119\ \ \ EXPECT\_EQ(kCycleCount\ *\ kThreadCount,\ locked\_counter.value());}
\DoxyCodeLine{01120\ \}}
\DoxyCodeLine{01121\ }
\DoxyCodeLine{01122\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{01123\ \textcolor{keywordtype}{void}\ RunFromThread(\textcolor{keywordtype}{void}\ (func)(T),\ T\ param)\ \{}
\DoxyCodeLine{01124\ \ \ ThreadWithParam<T>\ thread(func,\ param,\ \textcolor{keyword}{nullptr});}
\DoxyCodeLine{01125\ \ \ thread.Join();}
\DoxyCodeLine{01126\ \}}
\DoxyCodeLine{01127\ }
\DoxyCodeLine{01128\ \textcolor{keywordtype}{void}\ RetrieveThreadLocalValue(}
\DoxyCodeLine{01129\ \ \ \ \ pair<ThreadLocal<std::string>*,\ std::string*>\ param)\ \{}
\DoxyCodeLine{01130\ \ \ *param.second\ =\ param.first-\/>get();}
\DoxyCodeLine{01131\ \}}
\DoxyCodeLine{01132\ }
\DoxyCodeLine{01133\ TEST(ThreadLocalTest,\ ParameterizedConstructorSetsDefault)\ \{}
\DoxyCodeLine{01134\ \ \ ThreadLocal<std::string>\ thread\_local\_string(\textcolor{stringliteral}{"{}foo"{}});}
\DoxyCodeLine{01135\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}foo"{}},\ thread\_local\_string.get().c\_str());}
\DoxyCodeLine{01136\ }
\DoxyCodeLine{01137\ \ \ thread\_local\_string.set(\textcolor{stringliteral}{"{}bar"{}});}
\DoxyCodeLine{01138\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}bar"{}},\ thread\_local\_string.get().c\_str());}
\DoxyCodeLine{01139\ }
\DoxyCodeLine{01140\ \ \ std::string\ result;}
\DoxyCodeLine{01141\ \ \ RunFromThread(\&RetrieveThreadLocalValue,}
\DoxyCodeLine{01142\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ make\_pair(\&thread\_local\_string,\ \&result));}
\DoxyCodeLine{01143\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}foo"{}},\ result.c\_str());}
\DoxyCodeLine{01144\ \}}
\DoxyCodeLine{01145\ }
\DoxyCodeLine{01146\ \textcolor{comment}{//\ Keeps\ track\ of\ whether\ of\ destructors\ being\ called\ on\ instances\ of}}
\DoxyCodeLine{01147\ \textcolor{comment}{//\ DestructorTracker.\ \ On\ Windows,\ waits\ for\ the\ destructor\ call\ reports.}}
\DoxyCodeLine{01148\ \textcolor{keyword}{class\ }DestructorCall\ \{}
\DoxyCodeLine{01149\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{01150\ \ \ DestructorCall()\ \{}
\DoxyCodeLine{01151\ \ \ \ \ invoked\_\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{01152\ \textcolor{preprocessor}{\#if\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{01153\ \ \ \ \ wait\_event\_.Reset(::CreateEvent(NULL,\ TRUE,\ FALSE,\ NULL));}
\DoxyCodeLine{01154\ \ \ \ \ GTEST\_CHECK\_(wait\_event\_.Get()\ !=\ NULL);}
\DoxyCodeLine{01155\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01156\ \ \ \}}
\DoxyCodeLine{01157\ }
\DoxyCodeLine{01158\ \ \ \textcolor{keywordtype}{bool}\ CheckDestroyed()\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{01159\ \textcolor{preprocessor}{\#if\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{01160\ \ \ \ \ \textcolor{keywordflow}{if}\ (::WaitForSingleObject(wait\_event\_.Get(),\ 1000)\ !=\ WAIT\_OBJECT\_0)}
\DoxyCodeLine{01161\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{01162\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01163\ \ \ \ \ \textcolor{keywordflow}{return}\ invoked\_;}
\DoxyCodeLine{01164\ \ \ \}}
\DoxyCodeLine{01165\ }
\DoxyCodeLine{01166\ \ \ \textcolor{keywordtype}{void}\ ReportDestroyed()\ \{}
\DoxyCodeLine{01167\ \ \ \ \ invoked\_\ =\ \textcolor{keyword}{true};}
\DoxyCodeLine{01168\ \textcolor{preprocessor}{\#if\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{01169\ \ \ \ \ ::SetEvent(wait\_event\_.Get());}
\DoxyCodeLine{01170\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01171\ \ \ \}}
\DoxyCodeLine{01172\ }
\DoxyCodeLine{01173\ \ \ \textcolor{keyword}{static}\ std::vector<DestructorCall*>\&\ List()\ \{\ \textcolor{keywordflow}{return}\ *list\_;\ \}}
\DoxyCodeLine{01174\ }
\DoxyCodeLine{01175\ \ \ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ ResetList()\ \{}
\DoxyCodeLine{01176\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{size\_t}\ i\ =\ 0;\ i\ <\ list\_-\/>size();\ ++i)\ \{}
\DoxyCodeLine{01177\ \ \ \ \ \ \ \textcolor{keyword}{delete}\ list\_-\/>at(i);}
\DoxyCodeLine{01178\ \ \ \ \ \}}
\DoxyCodeLine{01179\ \ \ \ \ list\_-\/>clear();}
\DoxyCodeLine{01180\ \ \ \}}
\DoxyCodeLine{01181\ }
\DoxyCodeLine{01182\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{01183\ \ \ \textcolor{keywordtype}{bool}\ invoked\_;}
\DoxyCodeLine{01184\ \textcolor{preprocessor}{\#if\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{01185\ \ \ AutoHandle\ wait\_event\_;}
\DoxyCodeLine{01186\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{01187\ \ \ \textcolor{keyword}{static}\ std::vector<DestructorCall*>*\ \textcolor{keyword}{const}\ list\_;}
\DoxyCodeLine{01188\ }
\DoxyCodeLine{01189\ \ \ GTEST\_DISALLOW\_COPY\_AND\_ASSIGN\_(DestructorCall);}
\DoxyCodeLine{01190\ \};}
\DoxyCodeLine{01191\ }
...
\DoxyCodeLine{01282\ }
\DoxyCodeLine{01283\ \textcolor{preprocessor}{\#if\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{01284\ TEST(WindowsTypesTest,\ HANDLEIsVoidStar)\ \{}
\DoxyCodeLine{01285\ \ \ StaticAssertTypeEq<HANDLE,\ void*>();}
\DoxyCodeLine{01286\ \}}
\DoxyCodeLine{01287\ }
\DoxyCodeLine{01288\ \textcolor{preprocessor}{\#if\ GTEST\_OS\_WINDOWS\_MINGW\ \&\&\ !defined(\_\_MINGW64\_VERSION\_MAJOR)}}
