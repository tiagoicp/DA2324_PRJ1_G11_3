...
\hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e}{}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e}\index{Generic Build Instructions@{Generic Build Instructions}}
\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md27}%
\Hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md27}%
 \hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md28}{}\doxysubsubsection{\texorpdfstring{Setup}{Setup}}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md28}
To build Google\+Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md29}{}\doxysubsection{\texorpdfstring{Build with CMake}{Build with CMake}}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md29}
...
CMake works by generating native makefiles or build projects that can be used in the compiler environment of your choice. You can either build Google\+Test as a standalone project or it can be incorporated into an existing CMake build for another project.\hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md30}{}\doxysubsubsection{\texorpdfstring{Standalone CMake Project}{Standalone CMake Project}}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md30}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md31}{}\doxysubsubsection{\texorpdfstring{Incorporating Into An Existing CMake Project}{Incorporating Into An Existing CMake Project}}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md31}
...
Note that this approach requires CMake 3.\+14 or later due to its use of the {\ttfamily Fetch\+Content\+\_\+\+Make\+Available()} command.\hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md32}{}\doxyparagraph{\texorpdfstring{Visual Studio Dynamic vs Static Runtimes}{Visual Studio Dynamic vs Static Runtimes}}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md32}
...
Enabling this option will make gtest link the runtimes dynamically too, and match the project in which it is included.\hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md33}{}\doxysubsubsection{\texorpdfstring{C++ Standard Version}{C++ Standard Version}}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md33}
An environment that supports C++11 is required in order to successfully build Google\+Test. One way to ensure this is to specify the standard in the top-\/level project, for example by using the {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD 11)} command. If this is not feasible, for example in a C project using Google\+Test for validation, then it can be specified by adding it to the options for cmake via the {\ttfamily DCMAKE\+\_\+\+CXX\+\_\+\+FLAGS} option.\hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md34}{}\doxysubsection{\texorpdfstring{Tweaking Google\+Test}{Tweaking Google\+Test}}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md34}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/master/googletest/include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md35}{}\doxysubsection{\texorpdfstring{Multi-\/threaded Tests}{Multi-\/threaded Tests}}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md35}
...
Note\+: while the above steps aren\textquotesingle{}t technically necessary today when using some compilers (e.\+g. GCC), they may become necessary in the future, if we decide to improve the speed of loading the library (see \href{http://gcc.gnu.org/wiki/Visibility}{\texttt{ http\+://gcc.\+gnu.\+org/wiki/\+Visibility}} for details). Therefore you are recommended to always add the above flags when using Google\+Test as a shared library. Otherwise a future release of Google\+Test may break your build script.\hypertarget{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md37}{}\doxysubsection{\texorpdfstring{Avoiding Macro Name Clashes}{Avoiding Macro Name Clashes}}\label{md_lib_2googletest-master_2googletest_2_r_e_a_d_m_e_autotoc_md37}
